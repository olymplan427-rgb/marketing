...
type IconType = 'tistory' | 'instagram' | 'threads' | 'content-history' | 'ai-settings' | 'prompt-settings' | 'sns-management' | 'dark-mode';
...
const Header: React.FC<HeaderProps> = ({ title, subtitle, iconType }) => {
    const renderIcon = () => {
        switch (iconType) {
            ...
            case 'threads':
                return (
                    <svg className="w-7 h-7 text-white" viewBox="0 0 192 192" fill="currentColor">
            ...
            default:
                return (
                    <svg className="w-7 h-7 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
