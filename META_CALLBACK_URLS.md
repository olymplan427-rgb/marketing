...
Vercel 배포 URL: **https://<your-project>.vercel.app**
...
**입력할 URL:**
```
https://<your-project>.vercel.app/api/threads/deletion
```
...
**입력할 URL:**
```
https://<your-project>.vercel.app/api/threads/deauthorize
```
...
| `VITE_THREADS_REDIRECT_URI` | `https://<your-project>.vercel.app/auth/threads/callback` | Production |
...
```bash
# 데이터 삭제 엔드포인트 테스트
curl https://<your-project>.vercel.app/api/threads/deletion

# 권한 제거 엔드포인트 테스트
curl https://<your-project>.vercel.app/api/threads/deauthorize
```
